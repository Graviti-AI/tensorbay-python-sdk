...
class TestBranch:
    def test_create_branch(self, accesskey, url):
        ...
        assert branch.commit_id == commit_1_id
    ...
    def test_get_branch(self, accesskey, url):
        ...
        commit_1_id = dataset_client.status.commit_id
        dataset_client.create_draft("draft-2")
        dataset_client.commit("commit-2", "test")
    ...
    def test_delete_branch(self, accesskey, url):
        ...
        # After deleting the branch, the commit in the branch will not be deleted
        dataset_client.get_commit(commit_2_id)
