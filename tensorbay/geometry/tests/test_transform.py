...
from .. import Quaternion, Transform3D, Vector3D
...
class TestTransform3D:
    ...
    def test_mul(self):
        ...
        assert transform_1 * quaternion == transform_3
    ...
    def test_rmul(self):
        ...
        with pytest.raises(TypeError):
            1 * transform_1
        assert quaternion * transform_1 == transform_2
    ...
    def test_set_rotation(self):
        ...
        transform.set_rotation(w=0, x=1, y=1, z=0)
        assert transform.rotation == Quaternion(0, 1, 1, 0)
