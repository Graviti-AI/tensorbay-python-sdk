...
DEFAULT_BRANCH = "main"
FIRST_VOID_COMMIT_ID = "00000000000000000000000000000000"
...
class GAS:
    ...
    def create_dataset(
        ...
        *,
        ...
        status = Status(DEFAULT_BRANCH, commit_id=FIRST_VOID_COMMIT_ID)
    ...
    def get_dataset(self, name: str, is_fusion: bool = False) -> DatasetClientType:
        ...
        dataset_id = info["id"]
        type_flag = info["type"]
        commit_id = info["commitId"] if info["commitId"] else FIRST_VOID_COMMIT_ID
        default_branch = info["defaultBranch"]
