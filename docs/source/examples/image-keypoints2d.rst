...
:ref:`features:Keypoints2D` is a kind of label type. It represents the 2D Keypoints labels on
images. (:numref:`Fig. %s <example-Keypoints2D>`)
...
In each :ref:`basic_concepts:Data`, there is a sequence of :ref:`features:Keypoints2D` annotations.
...
-  Creating :ref:`features:Keypoints2D` and adding annotations.
-  Appending the Keypoints2D labels to the created Data.
-  Appending the Data to the created Segment.

See :ref:`this page <features:Keypoints2D>` for more details
